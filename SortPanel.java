...
public class SortPanel extends JPanel implements ISortPanel {

   private BufferedImage myImage;
   private final int scale = 100;
   private final int screenSize = 1000;
   private final int delayLength = 700;
   ...
   public SortPanel() {
      ...
      //instantiate a SelectionSort object
      SelectionSort sort = new SelectionSort(myArray, this);
      //instantiate an InsertionSort object
   ...
   private int[] generateArray(){
   	// set array to random size from 15 to 24 elements
      int size = (int) (Math.random() * 10 + 15);
